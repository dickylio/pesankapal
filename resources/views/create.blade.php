    ...
    <div class="flex h-full">
        ...
        <div class="w-full md:w-1/2 bg-white flex flex-col md:py-14 px-5">
            ...
            <form action="{{ route('users.store') }}" method="POST" class="space-y-5">
                ...
                <div class="pt-2">
                    <button type="submit"
                            class="w-40 bg-gray-400 hover:bg-gray-500 text-white font-medium py-3 px-4 rounded-full transition duration-300">
                        Create Account
                    </button>
                </div>
                ...
                <!-- Login Link -->
                <div class="text-sm">
                    Already have an account? <a href="{{ url('/signin') }}" class="text-gray-800 font-medium">Log in</a>
                </div>
            </form>
        </div>
